...
const DEFAULTS: DonationData = {
  ...
  causes: [
    ...
    { key: 'orphanCare',          label: 'Orphan Care',           desc: 'Education and welfare for orphaned children.',        impact: 'Gives a child a future',        image: 'https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?auto=format&fit=crop&w=600&q=80', color: '#f43f5e' },
    ...
    { key: 'endingTorment',       label: 'Ending Torment',        desc: 'Support for victims of abuse and hardship.',          impact: 'Breaks cycles of poverty',     image: 'https://images.unsplash.com/photo-1469571486292-0ba58a3f068b?auto=format&fit=crop&w=600&q=80', color: '#8b5cf6' },
    { key: 'studentCare',         label: 'Student Care',          desc: 'Scholarships and educational resources.',             impact: 'Secures a future',             image: 'https://images.unsplash.com/photo-1503676260728-1c00da094a0b?auto=format&fit=crop&w=600&q=80', color: '#0ea5e9' },
    ...
    { key: 'eidClothes',          label: 'Eid Clothes',           desc: 'New clothes for children during Eid celebrations.',   impact: 'Brings joy to children',       image: 'https://images.unsplash.com/photo-1604328702728-d26d2062c20b?auto=format&fit=crop&w=600&q=80', color: '#f59e0b' },
