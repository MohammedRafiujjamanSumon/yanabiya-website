...
const DEFAULTS: DonationData = {
  ...
  causes: [
    ...
    { key: 'orphanCare',          label: 'Orphan Care',           desc: 'Education and welfare for orphaned children.',        impact: 'Gives a child a future',        image: 'https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&w=600&q=80', color: '#f43f5e' },
