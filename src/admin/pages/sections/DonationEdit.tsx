...
const DEFAULTS: DonationData = {
  ...
  causes: [
    { key: 'masjidSupport',       label: 'Masjid Support',        desc: 'Construction and maintenance of mosques.',            impact: 'Builds a house of prayer',     image: '/images/donation/masjid-support.jpg', color: '#10b981' },
    { key: 'orphanCare',          label: 'Orphan Care',           desc: 'Education and welfare for orphaned children.',        impact: 'Gives a child a future',        image: '/images/donation/orphan-care.jpg', color: '#f43f5e' },
    { key: 'elderlyHome',         label: 'Elderly Home',          desc: 'Care and dignity for the elderly in need.',           impact: 'Restores dignity to elders',    image: '/images/donation/elderly-home.jpg', color: '#0ea5e9' },
    ...
    { key: 'endingTorment',       label: 'Ending Torment',        desc: 'Support for victims of abuse and hardship.',          impact: 'Breaks cycles of poverty',     image: '/images/donation/ending-torment.jpg', color: '#8b5cf6' },
    ...
    { key: 'specialCare',         label: 'Special Care',          desc: 'Support for people with disabilities.',               impact: 'Enables independence',         image: '/images/donation/special-care.jpg', color: '#10b981' },
