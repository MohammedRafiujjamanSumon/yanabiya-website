...
const CC_DEFAULTS: CCData = {
  pillars: [
    { label: 'Welfare',       description: 'Structured charitable drives supporting families in need with dignity and transparency.',             image: 'https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?auto=format&fit=crop&w=400&q=80', bg: 'bg-emerald-500' },
    { label: 'Education',     description: 'Scholarships, school programmes and learning resources for underserved communities.',                 image: 'https://images.unsplash.com/photo-1503676260728-1c00da094a0b?auto=format&fit=crop&w=400&q=80', bg: 'bg-sky-500' },
