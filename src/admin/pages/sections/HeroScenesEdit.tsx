    ...
    api.getSection('hero-scenes')
      ...
      .catch(() => {
        ...
        setScenes([
          ...
          { id: 's5', eyebrow: 'Scene 05 · Community', headline: 'Growth beyond business.', body: 'Empowering communities and creating sustainable impact.', photo: 'https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&w=1600&q=80', photoPos: 'center', cta: { label: 'Explore Community', href: '/community' } },
          { id: 's6', eyebrow: 'Scene 06 · Leadership', headline: 'Visionary leadership.', body: 'Turning ideas into global success stories.', photo: 'https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&w=1600&q=80', photoPos: 'center top', cta: { label: 'Meet Our Leadership', href: '/leadership/management' } },
