    ...
    api.getSection('hero-scenes')
      ...
      .catch(() => {
        ...
        setScenes([
          ...
          { id: 's5', eyebrow: 'Scene 05 · Community', headline: 'Growth beyond business.', body: 'Empowering communities and creating sustainable impact.', photo: 'https://images.unsplash.com/photo-1521737604893-d14cc237f11d?auto=format&fit=crop&w=1600&q=80', photoPos: 'center', cta: { label: 'Explore Community', href: '/community' } },
