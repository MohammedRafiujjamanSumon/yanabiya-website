    ...
    <>
      ...
      <Section id="donation" className="relative overflow-hidden bg-[#F9F5EC] !pt-0">
        ...
        <div className="container-x py-12">
          ...
          {/* ── Activity Gallery — 2 photos | video | 2 photos ──── */}
          <section className="max-w-4xl mx-auto mb-12">
            <div className="text-center mb-5">
              <div className="inline-flex items-center gap-2 mb-2">
                <span className="block w-6 h-px bg-amber-400 rounded-full" />
                <span className="text-[9px] font-bold uppercase tracking-[0.28em] text-amber-700">From the ground</span>
                <span className="block w-6 h-px bg-amber-400 rounded-full" />
              </div>
              <h3 className="font-serif text-slate-900 text-lg md:text-xl">
            ...
            <div className="flex flex-col md:flex-row gap-3 items-stretch">
              ...
              <div className="flex-1 md:basis-1/4 flex md:flex-col gap-3">
                <figure className="group relative flex-1 overflow-hidden rounded-xl shadow-sm hover:shadow-md transition-all aspect-[4/3]">
              ...
              {/* Center: video card, taller (covers both photo rows) */}
              <div className="md:basis-2/4 relative rounded-xl overflow-hidden shadow-md bg-slate-900 aspect-[4/3] md:aspect-auto">
                <img
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white px-4">
                  <button
                    ...
                    className="w-14 h-14 md:w-16 md:h-16 rounded-full bg-amber-400 text-slate-950 grid place-items-center shadow-2xl hover:scale-110 transition-transform"
                  >
