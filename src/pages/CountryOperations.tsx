...
const OPS: Record<string, CountryOps> = {
  BD: {
    ...
    services: [
      { label: 'Technology & Digital Solutions',        desc: 'Custom software, web platforms, ERP, and AI solutions.',                  icon: Cpu,       slug: 'it-software',      image: 'https://images.unsplash.com/photo-1461749280684-dccba630e2f6?auto=format&fit=crop&w=800&q=80' },
    ...
    categories: [
      ...
      { label: 'International Maritime Transport',       icon: Ship,         tone: 'from-cyan-500/40 to-sky-700/40',       image: 'https://images.unsplash.com/photo-1605281317010-fe5ffe798166?auto=format&fit=crop&w=400&q=70' },
      ...
      { label: 'Software & Network Installation',        icon: Cpu,          tone: 'from-teal-500/40 to-teal-700/40',      image: 'https://images.unsplash.com/photo-1517694712202-14dd9538aa97?auto=format&fit=crop&w=400&q=70' },
  ...
  OM: {
    ...
    currentProjects: [
      ...
      { title: 'Cloud & Software Engagements',  body: 'Active enterprise IT projects spanning AWS, Microsoft, Oracle and SAP stacks.',          image: 'https://images.unsplash.com/photo-1517694712202-14dd9538aa97?auto=format&fit=crop&w=800&q=80' },
