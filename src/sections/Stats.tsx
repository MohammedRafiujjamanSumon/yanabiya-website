              ...
              return (
                <Reveal key={s.label} delay={i * 90}>
                  <div className="flex flex-col items-center text-center">
                    <div className="w-10 h-10 rounded-full bg-brand-accent/15 text-brand-accentDark
                                    grid place-items-center mb-2">
                      <Icon size={18} strokeWidth={2} />
                    </div>
                    <div className="font-serif text-3xl md:text-4xl text-brand-deep leading-none">
                      {s.value}
                    </div>
                    <div className="mt-1.5 text-[11px] md:text-xs uppercase tracking-[0.22em]
