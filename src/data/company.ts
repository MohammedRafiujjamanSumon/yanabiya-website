export const company = {
  ...
  pillars: [
    {
      title: 'People',
      body: 'A skilled workforce experienced across business domains and modern technologies.',
    },
    {
      title: 'Process',
      body: 'Balancing quality with efficiency in development timelines and costs.',
    },
    {
      title: 'Clients',
      body: 'Continuously improving satisfaction through teamwork and individual recognition.',
    },
  ],
  values: [
