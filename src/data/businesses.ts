...
export const businesses: Business[] = [
  ...
  },
  {
    ...
    features: [
      ...
      'Product sourcing, listing & catalogue management',
      'Secure payment gateway & checkout solutions',
      'Order management & last-mile delivery',
    ...
    countries: [
      ...
      { code: 'BD', note: 'Product sourcing, catalogue & local e-commerce.' },
      { code: 'US', note: 'US market digital retail & B2B trade.' },
    ],
    subServices: [
      {
        ...
        body: 'Yanabiya-owned storefronts selling garments, accessories, IT hardware, and everyday essentials directly to consumers.',
        image: 'https://images.unsplash.com/photo-1563013544-824ae1b704d3?auto=format&fit=crop&w=800&q=80',
        features: [
          ...
          'Promotional campaigns & discount management',
          'Customer reviews & ratings system',
        ],
        countries: [
          { code: 'OM', note: 'Flagship online store serving Oman.' },
          { code: 'GB', note: 'UK consumer retail platform.' },
          { code: 'BD', note: 'Bangladesh local e-commerce storefront.' },
          { code: 'US', note: 'US digital retail operations.' },
        ],
      },
      {
        slug: 'marketplace-management',
        icon: Globe,
        title: 'Multi-Platform Marketplace',
        body: 'Selling and managing Yanabiya products across major global marketplaces including Amazon, eBay, and regional platforms.',
        image: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&w=800&q=80',
        features: [
          'Amazon, eBay & regional marketplace listings',
          'Multi-channel product synchronisation',
          'Marketplace account management',
          'Competitive pricing & buy-box strategy',
          'Seller analytics & performance reporting',
          'Cross-marketplace order consolidation',
        ],
        countries: [
          { code: 'OM', note: 'Middle East marketplace presence.' },
          { code: 'GB', note: 'Amazon UK & eBay operations.' },
          { code: 'BD', note: 'Daraz & regional marketplace listings.' },
          { code: 'US', note: 'Amazon US & US marketplace management.' },
        ],
      },
      {
        ...
        features: [
          ...
          'Customer notification & delivery updates',
        ],
        countries: [
          { code: 'OM', note: 'Oman warehouse & delivery network.' },
          { code: 'GB', note: 'UK 3PL & fulfilment partnerships.' },
          { code: 'BD', note: 'Bangladesh fulfilment & courier network.' },
          { code: 'US', note: 'US distribution & last-mile delivery.' },
        ],
      },
      {
        ...
        features: [
          ...
          'Credit/debit card & digital wallet support',
        ...
        countries: [
          { code: 'OM', note: 'OMR & multi-currency payment support.' },
          { code: 'GB', note: 'GBP & EU payment gateway operations.' },
          { code: 'BD', note: 'BDT & mobile banking integrations.' },
          { code: 'US', note: 'USD & US payment processing.' },
        ],
      },
    ],
  },
  {
    slug: 'yanabiya-digital-platform',
    icon: Monitor,
    title: 'Yanabiya Digital Platform',
    body: 'Yanabiya\'s proprietary suite of digital apps and service platforms built to streamline operations across all business verticals.',
    details:
      'Yanabiya Digital Platform is our in-house ecosystem of web and mobile applications designed to power internal operations, client services, and field management across all Yanabiya Group verticals. From employee management and field operations to customer-facing service portals and business dashboards, our digital platform unifies data, workflows, and communications in one place.',
    features: [
      'Yanabiya Group internal business apps',
      'Customer-facing service & support portals',
      'Field operations & workforce management apps',
      'Business intelligence dashboards & reporting',
      'Employee HR & payroll management system',
      'CRM & client relationship tools',
      'Document management & digital workflows',
      'API integrations across all business verticals',
    ...
    subServices: [
      {
        ...
        features: [
          ...
          'Cross-country operations visibility',
          'Finance & expense management',
          'Task & project assignment tools',
          'Executive reporting & analytics',
        ],
        countries: [
          { code: 'OM', note: 'Central HQ business management.' },
          { code: 'GB', note: 'UK operations monitoring.' },
          { code: 'BD', note: 'Bangladesh vertical management.' },
          { code: 'US', note: 'US business performance tracking.' },
        ],
      },
      {
        ...
        features: [
          ...
          'Client document upload & management',
          'Service history & account dashboard',
          'Multi-language customer support',
        ],
        countries: [
          { code: 'OM', note: 'Oman client service & support hub.' },
          { code: 'GB', note: 'UK customer support portal.' },
          { code: 'BD', note: 'Bangladesh client service platform.' },
          { code: 'US', note: 'US customer portal & ticketing.' },
        ],
      },
      {
        ...
        body: 'Mobile app for field staff, supervisors, and site managers to log tasks, track locations, and manage on-ground operations in real time.',
        image: 'https://images.unsplash.com/photo-1504868584819-f8e8b4b6d7e3?auto=format&fit=crop&w=800&q=80',
        features: [
          'Field staff GPS tracking & check-in',
        ...
        countries: [
          { code: 'OM', note: 'Oman facility & security field ops.' },
          { code: 'GB', note: 'UK field staff management.' },
          { code: 'BD', note: 'Bangladesh field workforce tracking.' },
          { code: 'US', note: 'US field operations & site management.' },
        ],
      },
      {
        ...
        body: 'Centralised HR and payroll platform managing employee records, leave, contracts, and salary processing across all Yanabiya Group countries.',
        image: 'https://images.unsplash.com/photo-1507679799987-c73779587ccf?auto=format&fit=crop&w=800&q=80',
        features: [
          'Employee records & contract management',
          'Leave, attendance & shift scheduling',
          'Multi-country payroll processing',
          'Performance review & appraisal tools',
          'Onboarding & offboarding workflows',
          'Compliance & labour law tracking',
        ],
        countries: [
          { code: 'OM', note: 'Oman HQ HR & payroll centre.' },
          { code: 'GB', note: 'UK employee records & payroll.' },
          { code: 'BD', note: 'Bangladesh HR management system.' },
          { code: 'US', note: 'US payroll & compliance platform.' },
        ],
      },
    ],
  },
