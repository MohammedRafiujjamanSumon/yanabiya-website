...
export const ALL_PEOPLE: PersonData[] = [
  ...
  },
  {
    ...
    tier: 'board',
    tierLabel: 'Tier 02, Global Executive Management',
    shortBio: 'Co-Founder supporting Yanabiya Group\'s strategic direction across all business divisions.',
    fullBio: [
      'S M Momim Ahmed is a Co-Founder of Yanabiya Group, supporting the Group\'s strategic direction and contributing to its long-term growth across all business divisions.',
      'His focus on cross-functional collaboration and operational quality has been central to the Group\'s sustained growth across all markets.',
    ],
  },
  {
    id: 'sumon-ahmed',
    ...
    tier: 'board',
    tierLabel: 'Tier 02, Global Executive Management',
    shortBio: 'Co-Founder driving cross-divisional governance and the Group\'s South Asia growth agenda.',
    fullBio: [
      'S M Sumon Ahmed is a Co-Founder of Yanabiya Group, working closely with the Chairman and senior leadership to ensure cohesive leadership across all subsidiaries.',
      'He plays a key role in strategic planning, stakeholder engagement, and the execution of the Group\'s long-term growth agenda from Bangladesh.',
    ],
  },
  {
    id: 'jhohora-akter',
    ...
    tier: 'board',
    tierLabel: 'Tier 02, Global Executive Management',
    shortBio: 'Co-Founder supporting senior leadership in governance and strategic coordination.',
    fullBio: [
      'Jhohora Akter is a Co-Founder of Yanabiya Group, supporting the senior leadership team in day-to-day governance and strategic coordination across all four operating countries.',
...

  {
    ...
    fullBio: [
      'Jannatul Ferdows leads Global Accountancy at Yanabiya Group, supporting cross-border financial operations, consolidated reporting, and day-to-day accounting governance across the Group\'s operating entities in Oman, the United Kingdom, the United States, and Bangladesh.',
